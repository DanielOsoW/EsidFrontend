<template>
    ...
    <v-row >
            <div class="ml-10">
              <h3>Administradora ESID: Daniela Cornejo Kurtic</h3>
              <h4>daniela.cornejo@usach.cl</h4>
              <h4>IP: </h4>
            </div>
    </v-row>
    <br/><br/>
    <v-row >
            <div class="ml-10">
              <h3>Soporte TIC ESID: Alguien</h3>
              <h4>alguien@usach.cl</h4>
              <h4>IP: </h4>
            </div>
    </v-row>
  ...
  <script>
    export default {
        data: () => ({
          items:[
            {'id':1,'titulo':'Longa','enunciado':'longueiro','estado':'Listo','resolucion':'Aceptado'},
            {'id':2,'titulo':'Longo','enunciado':'longueira','estado':'En proceso', 'resolucion':''},
            {'id':3,'titulo':'Longe','enunciado':'longueire','estado':'Denegado', 'resolucion':'No se puede dar acceso puesto que no se pudo verificar que lleva a cabo clases en la sala y el horario que indica'}
          ],
          citems:[
