        ...
        <form @submit.prevent="handleSubmit"> 
            ...
            <v-content> 
                <v-card width="auto" class="mx-auto mt-9"> 
                    ...
                    <v-card-text> 
                        <v-text-field label="Correo" class="form-control mr-2 ml-2" color="orange-darken-2" v-model="correo" prepend-icon="mdi-account-circle"/> 
                        <v-text-field label="Contraseña" class="form-control mr-2 ml-2" color="orange-darken-2" v-model="password"   
