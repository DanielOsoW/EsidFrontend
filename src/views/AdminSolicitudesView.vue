<template>
    <v-container>
        <v-card color="white" class="pa-2 mt-2"
          dark>
      <!--v-row align="center"
              class="pa-2">
       <v-btn
    ...
    <v-row justify="center" align="center">
            <v-col cols="auto">
              <v-btn variant="outlined" class="primary mr-2" color="teal-lighten-1" @click="iterador=0">TODAS</v-btn>
            </v-col>
            <v-col cols="auto">
              <v-btn variant="outlined" class="primary mr-2" color="grey-darken-1" @click="iterador=2">PENDIENTES</v-btn>
            </v-col>
            <v-col cols="auto">
              <v-btn variant="outlined" class="primary mr-2" color="light-green-darken-1" @click="iterador=1">APROBADAS</v-btn>
            </v-col>
            <v-col cols="auto">
              <v-btn variant="outlined" class="primary mr-2" color="deep-orange-darken-1" @click="iterador=3">EN PROCESO</v-btn>
            </v-col>
            <v-col cols="auto">
              <v-btn variant="outlined" class="primary mr-2" color="red-darken-1" @click="iterador=4">DENEGADO</v-btn>
            </v-col>
    </v-row>
    <v-col align="justify-center" class="mt-3">
      <v-row align="center"
              ...
              <v-container>
                ...
                <v-card
                  v-if="(iterador == 0 || iterador == 2) && (item.estado==2)"
                  class="pa-2" 
                  color="grey-darken-1"
                  dark
                >
                ...
                <v-card
                  v-if="(iterador == 0 || iterador == 1) && item.estado==1"
                  class="pa-2" 
                ...
                <v-card
                  v-if="(iterador == 0 || iterador == 3) && item.estado==3"
                  class="pa-2" 
                ...
                >
                  ...
                  <br>
                  <v-card-actions>
                      <v-btn disabled variant="outlined" color="black" @click="goToData(item.id)">
                        Visualizar Datos
                      </v-btn>
                      <v-btn variant="outlined" color="black" @click="goToData(item.id)">
                        Visualizar Datos
                ...
                <v-card
                  v-if="(iterador == 0 || iterador == 4) && item.estado==4"
                  class="pa-2" 
                  color="red-darken-1"
                  dark
                >
  ...
  <script>
    export default {
        data: () => ({
          items:[
            {'id':1,'titulo':'Longa','enunciado':'longueiro','estado':1,'resolucion':'Aceptado'},
            {'id':2,'titulo':'Longo','enunciado':'longueira','estado':2, 'resolucion':''},{'id':2,'titulo':'Longo','enunciado':'longueira','estado':2, 'resolucion':''},{'id':2,'titulo':'Longo','enunciado':'longueira','estado':2, 'resolucion':''},
            {'id':3,'titulo':'Longe','enunciado':'longueire','estado':4, 'resolucion':'No se puede dar acceso puesto que no se pudo verificar que lleva a cabo clases en la sala y el horario que indica'},
            
            {'id':3,'titulo':'Longe','enunciado':'longueire','estado':4, 'resolucion':'No se puede dar acceso puesto que no se pudo verificar que lleva a cabo clases en la sala y el horario que indica'},
  
            {'id':3,'titulo':'Longe','enunciado':'longueire','estado':4, 'resolucion':'No se puede dar acceso puesto que no se pudo verificar que lleva a cabo clases en la sala y el horario que indica'},
            {'id':4,'titulo':'HOLA','enunciado':'HOLA','estado':3,'resolucion':''},
          ],
          citems:[
